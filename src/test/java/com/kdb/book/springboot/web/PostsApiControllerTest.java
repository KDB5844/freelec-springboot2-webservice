...
@SpringBootTest(webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT) //WebMvcTest의 경우 JPA 기능이 작동하지 않음, 호스트가 사용하지 않는 랜덤 포트를 사용하겠다는 의미
public class PostsApiControllerTest {
    ...
    @Test
    @WithMockUser(roles = "USER")   //인증된 모의 사용자를 만들어 사용한다. roles에 권한 추가 가능
